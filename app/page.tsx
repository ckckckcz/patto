        ...
        <section className="flex items-center lg:justify-center min-h-screen px-4 py-12">
          <div className="max-w-4xl mx-auto text-center space-y-3">
            <div className="flex -space-x-4 rtl:space-x-reverse lg:justify-center">
              ...
              <div className="flex items-center justify-center w-10 h-10 text-xs font-bold text-black bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-full">+99</div>
            </div>
            <BlurText
